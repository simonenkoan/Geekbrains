...
def on_rel():
    ...
    def on_release(key):
        ...
        #cars = garage[random.randint(0, 2)]
        # print(cars.model)
...
with keyboard.Listener( on_release=on_release ) as listener:
    listener.join()
    # print('Кратковрмененно вышли')

    # while True:
    #     answer = input('''Нажмите вперед чтобы ехать, влево вправо чтобы поворачивать и назад чтобы остановиться:
    #     Чтобы сменить автомобиль нажмите Backspace\n''')
